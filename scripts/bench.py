...
def run_benchmark(runs: int = 100) -> None:
    ...
    def p50(data: list[float]) -> float: return statistics.median(data)
    def p95(data: list[float]) -> float: return sorted(data)[int(len(data) * 0.95)]
